<template>
  <div>
    <div>
      <el-row>
        <el-col :span="24">
          ...
          <el-col :span="1">生成</el-col>
          <el-col :span="1">暂存</el-col>
          <el-col :span="1">上报</el-col>
          <el-col :span="1">撤回</el-col>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="5">
          ...
          <el-col :span="16">
            <div>
              <el-input v-model="budgetReport.project" placeholder="请输入内容"></el-input>
            </div>
          </el-col>
        </el-col>
        <el-col :span="5">
          ...
          <el-col :span="16">
            <div class="block">
              <el-input v-model="budgetReport.department" placeholder="请输入内容"></el-input>
            </div>
          </el-col>
        </el-col>
        <el-col :span="5">
          ...
          <el-col :span="16">
            <div class="block">
              <el-input v-model="budgetReport.opposite" placeholder="请输入内容"></el-input>
            </div>
          </el-col>
        </el-col>
        <el-col :span="2">
    ...
    <div>
      <p>状态：{{budgetReport.status}}</p>
    </div>
    <el-table :data="budgetReport.list" height="250" size="small" border style="width: 100%">
      <!--<el-table-column prop="manipulate" label="操作"></el-table-column>-->
      ...
      <el-table-column prop="monthlyPayment" label="付款属性" width="180"></el-table-column>
