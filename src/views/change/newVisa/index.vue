    ...
    <el-tabs type="border-card">
      <el-tab-pane label="签证信息">
        ...
        <el-table highlight-current-row :data="contracts" style="width: 100%">
          ...
          <el-table-column prop="changeMoney" label="变更对应金额" width="200">
            <template slot-scope="scope">
              <div @click="dialogTableVisible = true">
                {{scope.row.changeMoney}}
                <i class="el-icon el-icon-caret-bottom" style="margin-left: 2%"></i>
              </div>
            </template>
          </el-table-column>
        ...
        <el-dialog title="" :visible.sync="dialogTableVisible">
          <el-table :data="contracts">
            ...
            <el-table-column property="address" label="合同对应金额"></el-table-column>
            <el-table-column property="address" label="总预留金余额"></el-table-column>
