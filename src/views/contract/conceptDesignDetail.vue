    ...
    <div style="background-color: #EEF2F6;padding: 8px">
      ...
      <div v-if="classA">
        ...
        <div style="background-color: #FFF">
          <el-row :gutter="20" style="margin-top: 1%;padding-left: 1%;line-height: 2;">
            <el-col :span="1" style="width: 2%">
              <div @click="businessInfo = !businessInfo" class="detail_dev1"></div>
            </el-col>
            <el-col :span="15" style="padding-left: 0">
              <!--<i class="el-icon-document"></i>-->
              <span @click="businessInfo = !businessInfo" style="color: #60696b;font-size: 14px;">商务信息</span>
            </el-col>
          </el-row>
        </div>
        <div v-show="businessInfo" style="background-color: #FFF">
          <el-form :model="form" ref="form" label-width="100px" class="demo-ruleForm">
            <el-row :gutter="20">
              <el-col :span="6" :offset="2">
                <el-form-item label="设计团队/主持人:">
                  <el-input v-model="form.organization" size="mini"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="合作方Email:">
                  <el-input v-model="form.organization" size="small"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="合作方固定座机:">
                  <el-input v-model="form.organization" size="small"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
              ...
              <el-col :span="14">
                <el-form-item label="主业态:">
                  <el-checkbox-group v-model="checkList">
                    ...
                    <el-checkbox label="办公楼"></el-checkbox>
        ...
        <div v-show="contractMoney" style="background-color: #FFF">
          <el-form :model="form" ref="form" label-width="100px" class="demo-ruleForm">
            <el-row :gutter="20">
              ...
              <el-col :span="6">
                <el-form-item label="合同金额(不含可抵扣税)(C=A-B):">
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="6">
                <el-form-item label="有效签约金额(计成本(E=C-D):">
        ...
        <div style="background-color: #FFF">
          <el-row :gutter="20" style="margin-top: 1%;padding-left: 1%;line-height: 2;">
            ...
            <el-col :span="6" style="padding-left: 0">
              <!--<i class="el-icon-document"></i>-->
              <span @click="contractPlan = !contractPlan" style="color: #60696b;font-size: 14px;">合约规划</span>
            </el-col>
          </el-row>
        </div>
        <div v-show="contractPlan" style="background-color: #FFF;padding: 8px">
          <el-table highlight-current-row :data="tableData" border
            ...
            <el-table-column prop="statusAccounting" label="所属项目" align="center"></el-table-column>
            ...
            <el-table-column prop="contractMoneyPlus" label="合同对应金额(不含税)(G)" align="center"></el-table-column>
        ...
        <div style="background-color: #FFF">
          <el-row :gutter="20" style="margin-top: 1%;padding-left: 1%;line-height: 2;">
            <el-col :span="1" style="width: 2%">
              <div @click="designFee = !designFee" class="detail_dev1"></div>
            </el-col>
            <el-col :span="16" style="padding-left: 0">
              <!--<i class="el-icon-document"></i>-->
              <span @click="designFee = !designFee" style="color: #60696b;font-size: 14px;">设计费指导价（备注：预案合同设计费指导价内：分业态规模=预案个数；单价=预案的设计费单价）</span>
            </el-col>
          </el-row>
        </div>
        <div v-show="designFee" style="background-color: #FFF;padding: 8px">
          <el-table highlight-current-row :data="tableData" border
                    :header-cell-style="{background:'#7A86A7',color:'#FFF',borderColor:'rgb(116, 127, 154)'}">
            <el-table-column prop="approvalStatus" label="专业" align="center"></el-table-column>
            <el-table-column prop="statusAccounting" label="业态分类" align="center"></el-table-column>
            <el-table-column prop="statusAccounting" label="阶段" align="center"></el-table-column>
            <el-table-column prop="nameContract" label="指导价" align="center">
              <el-table-column prop="engineering" label="指导价说明" align="center"></el-table-column>
              <el-table-column prop="design" label="单价（元/平方米）" align="center"></el-table-column>
              <el-table-column prop="constructionCost" label="备注" align="center"></el-table-column>
            </el-table-column>
            <el-table-column prop="supplierUnit" label="实际项目" align="center">
              <el-table-column prop="engineering" label="单价（元/平方米）" align="center"></el-table-column>
              <el-table-column prop="design" label="分业态规模（平方米）" align="center"></el-table-column>
              <el-table-column prop="constructionCost" label="分业态合同金额（元）" align="center"></el-table-column>
            </el-table-column>
            <el-table-column prop="contractMoneyPlus" label="项目分期" align="center"></el-table-column>
            <el-table-column prop="contractMoneyAfter" label="是否超出指导价" align="center"></el-table-column>
            <el-table-column prop="appliedAmount" label="超标类型" align="center"></el-table-column>
            <el-table-column prop="appliedAmount" label="超出集团指导价标准原因" align="center"></el-table-column>
            <el-table-column prop="appliedAmount" label="超出集团指导价标准的特殊事项审批链接" align="center"></el-table-column>
          </el-table>
        </div>
        <!--其他说明-->
        ...
        <!--付款方式-->
        <div style="background-color: #FFF" @click="payWay = !payWay">
          <el-row :gutter="20" style="margin-top: 1%;padding-left: 1%;line-height: 2;">
            <el-col :span="1" style="width: 2%">
              <div class="detail_dev1"></div>
            </el-col>
            <el-col :span="10" style="padding-left: 0">
              <span style="color: #60696b;font-size: 14px;">付款方式</span>
            </el-col>
          </el-row>
        </div>
        <el-collapse-transition>
          <div v-show="payWay" style="background-color: #FFF;padding: 8px">
            <el-table highlight-current-row :data="tableData" border
                      ...
                      style="width: 100%">
              <el-table-column prop="approvalStatus" label="付款方式名称"></el-table-column>
              <el-table-column prop="outLineCanSee" label="付款比率（%）" width="600"></el-table-column>
            </el-table>
          </div>
        </el-collapse-transition>
        <!--附件-->
        <div style="background-color: #FFF" @click="accessory = !accessory">
          <el-row :gutter="20" style="margin-top: 1%;padding-left: 1%;line-height: 2;">
            <el-col :span="1" style="width: 2%">
              <div class="detail_dev1"></div>
            </el-col>
            <el-col :span="10" style="padding-left: 0">
              <span style="color: #60696b;font-size: 14px;">附件</span>
            </el-col>
        ...
        <el-collapse-transition>
          <div v-show="accessory" style="background-color: #FFF;padding: 8px">
            <el-table highlight-current-row :data="tableData" border
                      :header-cell-style="{background:'#7986A9', 'text-align': 'center', color: 'white'}"
                      :cell-style="({row, column, rowIndex, columnIndex}) => (columnIndex === 3||columnIndex === 0)?{'text-align': 'center'}:{}"
                      style="width: 100%">
              <el-table-column prop="approvalStatus" label="附件类型"></el-table-column>
              <el-table-column prop="outLineCanSee" label="" width="600"></el-table-column>
              <el-table-column prop="outLineCanSee" label="附件名称" width="600"></el-table-column>
              <el-table-column prop="outLineCanSee" label="上传人" width="600"></el-table-column>
              <el-table-column prop="outLineCanSee" label="上传时间" width="600"></el-table-column>
