        ...
        <div v-show="contractMoney" style="background-color: #FFF">
          <el-form :model="form" ref="form" label-width="100px" class="demo-ruleForm">
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="6">
                <el-form-item label="有效签约金额(E=C-D):">
                  <el-input v-model="form.responsiblePerson" size="small"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :span="6" :offset="2">
                <el-form-item label="加价后金额(含税)(F):">
                  <el-input v-model="form.contractNum" size="small"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="加价后可抵扣税额(G):">
                  <el-input v-model="form.responsiblePerson" size="small"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="加价后金额(不含可抵扣税额)(H=F-G):">
                  <el-input v-model="form.responsiblePerson" size="small"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :span="6" :offset="2">
                <el-form-item label="发票类型:">
                  <el-select v-model="form.responsiblePerson" size="small">
                    <el-option label="增值税专用发票" value="shanghai"></el-option>
                    <el-option label="增值税专用发票" value="beijing"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="6">
              ...
              <el-col :span="6">
                <el-form-item label="币种:">
                  <el-select v-model="form.ourUnit" size="small">
