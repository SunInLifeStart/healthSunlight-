<template>
  ...
  <el-table :data="formatData" :span-method="objectSpanMethod" :row-style="showRow" v-bind="$attrs" style="width: 100%" :max-height="maxHeight" :stripe="stripe">
    <!-- <slot></slot> -->

    <!-- <el-table-column :fixed="fixed" :width="300" >
